...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/benefit/js/packages/dygraphs.js"></script>

    <link rel="stylesheet" href="${pageContext.request.contextPath}/benefit/js/packages/dygraph.css?v=<%=System.currentTimeMillis()%>">
...
<div class="container">
    ...
    <div id="header-wrapper">
        <div id="header-menu-wrapper">
            <ul id="header-menu">
                <li><a href="${pageContext.request.contextPath}/snapshot" id="menu-href-first" class="${snapshotHref}">Snapshot</a></li>
                <li><a href="${pageContext.request.contextPath}/prospects" class="${searchHref}">Search</a></li>
                <li><a href="${pageContext.request.contextPath}/prospects/create" class="${createHref}">Create</a></li>
            </ul>
        </div>

        <a href="${pageContext.request.contextPath}/prospects" id="logo-wrapper">
...
<%--    <div id="header-wrapper">--%>
<%--        <a href="${pageContext.request.contextPath}/prospects" class="button modern">+ Search</a>--%>
<%--        <div id="welcome">Hi <a href="${pageContext.request.contextPath}/users/edit/${sessionScope.userId}">${sessionScope.name}</a>!</div>--%>
<%--        <br class="clear"/>--%>
<%--    </div>--%>
    ...
    <div class="button-wrapper inside-container" style="margin-top:60px;">
        <a href="${pageContext.request.contextPath}/users" class="href-dotted-black ${usersHref}">Users</a>
    </div>
